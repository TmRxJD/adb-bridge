...
**The Tower support has moved to [adb-bridge](https://www.npmjs.com/package/adb-bridge).**

This package still works. It enables The Tower on adb-bridge and hands over, so
